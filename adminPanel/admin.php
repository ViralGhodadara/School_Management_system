    ...
    <div id="addStandard" class="section">
        ...
        <div class="container">
            <form method="post">
                <table>
                    <tr>
                        <p style="margin-bottom: -20px;">Please enter the standard.....</p>
                    </tr>
                    <tr>
                        <br>
                        <p id="error-std"></p>
                        ...
                        <?php
                            ...
                            if (isset($_POST['submit-addDivision'])) {
                                ...
                                if ($statCheckStandardDivision->rowCount() == 0) {
                                    ...
                                    $insert_division = 'INSERT INTO division (division_name, seat, standard) VALUES (?, ?, ?)';
                                    $statInsertDivision = $conn->prepare($insert_division);
                                    
                                    if ($statInsertDivision->execute([$divisionName, $seat, $standard])) {                                    
                                    ?>
                                ...
                                if ($statDataDivision->rowCount() > 0) {
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><a href="http://localhost/viral/school-system/adminPanel/operation/update.php?idupdate=<?php echo $dataOfDivision['id'];?>" title="Edit" target="blank"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>
                                            <td><a href="http://localhost/viral/school-system/adminPanel/operation/delete.php?idDelete=<?php echo $dataOfDivision['id'];?>" title="Delete" target="blank"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                                        </tr>
                                    <?php
                                    }
                                }
