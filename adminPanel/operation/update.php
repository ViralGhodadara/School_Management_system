    ...
    <div class="container">
        <form method="post">
            <table>
                ...
                <tr>
                    <input type="number" name="seat" placeholder="Seat" class="box" value="<?php echo $data['seat']; ?>" required>
                </tr>
                <?php
...
<?php
    if (isset($_POST['submit-update'])) {
        ...
        $update = "UPDATE division SET division_name = ?, seat = ?, standard = ? WHERE id = ?";
        ...
        if ($statUpdate->execute([$divisionName, $seat, $std, $id])) {
            session_start();
            $_SESSION['seat'] = $seat;
        ?>
            <script>
